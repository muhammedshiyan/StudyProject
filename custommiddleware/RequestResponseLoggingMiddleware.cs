...
public class RequestResponseLoggingMiddleware
{
    ...
    {
        Console.WriteLine("CustomMiddleware-RequestResponseLoggingMiddleware: Request incoming.");
        LogRequest(context);
        ...
        Console.WriteLine("CustomMiddleware-RequestResponseLoggingMiddleware: Request ongoing.");
    }
    ...
    private void LogResponse(HttpContext context)
    {
        ...
        responseLog.AppendLine("hiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii");
